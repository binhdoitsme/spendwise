...
export const tagColors = [
  ...
  { text: "text-fuchsia-800", bg: "bg-fuchsia-100" },
  { text: "text-violet-800", bg: "bg-violet-100" },
  { text: "text-sky-800", bg: "bg-sky-100" },
  { text: "text-emerald-800", bg: "bg-emerald-100" },
  { text: "text-slate-800", bg: "bg-slate-100" },
  { text: "text-stone-800", bg: "bg-stone-100" },
  { text: "text-zinc-800", bg: "bg-zinc-100" }
];
