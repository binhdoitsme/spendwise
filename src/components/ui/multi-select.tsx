...
interface MultiSelectProps
   ...
   * When true, displays a red ring around the select control.
   * Optional, defaults to false.
   */
  error?: boolean;
  ...
  /**
   * Callback function triggered when a new option is added.
...
>(
  (
    ...
    // Stop propagation of wheel events to prevent scrolling the page when scrolling the dropdown
      ...
      <div className="w-full">
        ...
        >
          ...
          <PopoverContent
            ...
            onWheel={handleWheel} // Prevent scroll propagation
          ...
          >
            <Command>
              ...
              <CommandList>
                <CommandGroup>
                  {searchQuery && !hasAnyOptionInclude(searchQuery) && (
                    <CommandItem
        ...
        {error && errorMessage && (
          <div className="flex items-center mt-1.5 text-sm text-destructive">
